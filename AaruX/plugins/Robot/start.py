...
from AaruX import Telegram, YouTube, app
from AaruX.misc import SUDOERS
from AaruX.plugins.Robot.playlist import del_plist_msg
from AaruX.plugins.Robot.sudoers import sudoers_list
from AaruX.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from AaruX.utils.decorators.language import LanguageStart
from AaruX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAO_YrO_BgfVJ3TYDtpx39H0swKeWp8AAs4GAAKptZlVNpFLOfPfuXUpBA")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/AARU_SUPPORT) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/AARU_SUPPORT"
                        ),
                    ],
                ]
            )
